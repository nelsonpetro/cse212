...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: We must use Add() to "Enqueue" a person
    ...
    // Defect(s) Found: Using _queue.Count - 1 we are never getting to the last item
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: We were not checking persons with
    //Infinite turns. If turn is 0 or less
    //That means infinite turns
